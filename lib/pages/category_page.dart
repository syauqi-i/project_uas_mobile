...
class _CategoryPageState extends State<CategoryPage> {
  ...
  // memanggil fungsi getAllCategoriesRepo dari database.dart
  ...
  // menampilkan dialog untuk menambah category baru
  void oppenDialog(Category? category) {
    if (category != null) {
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      // untuk menhilangkan dialog setelah tombol ditekan
                      setState(() {});
                              ...
                              trailing: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      oppenDialog(snapshot.data![index]);
                                    },
                                  ),
                                ],
                              ),
